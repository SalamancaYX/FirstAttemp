 ...
 */
@Repository
public class UserSmsListDaoImpl implements IUserSmsListDao {
    ...
    @Override
    public List<UserAppSmsFavList> queryListByMemberId(String memberId) {
        Map<String, Object> map = new HashMap<>();
        map.put("tableIndex",  (int)(Double.valueOf(memberId) % 100));
        return sst2.selectList(NAMESPACE + "selectByMemberId", memberId);
    }
    ...
    @Override
    public UserAppSmsFavList queryLastOneByMemberId(String memberId) {
        Map<String, Object> map = new HashMap<>();
        map.put("tableIndex", (int)(Double.valueOf(memberId) % 100));
        map.put("memberId",memberId);
